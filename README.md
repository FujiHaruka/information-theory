...
| 15 | Distributed source coding | [`slepian_wolf_full_rate_region_achievability`](InformationTheory/Shannon/SlepianWolf/FullRateRegion/PairBound.lean) · [`mac_converse`](InformationTheory/Shannon/MultipleAccess/Converse.lean) (MAC capacity-region outer bound (per-letter conditional MI sum form)) · [`mac_achievability`](InformationTheory/Shannon/MultipleAccess/Achievability.lean) (MAC achievability (corner-point form)) · [`mac_capacity_region_reconciliation`](InformationTheory/Shannon/MultipleAccess/Reconciliation.lean) (MAC reconciliation: achievability corner informations = converse conditional/joint MI on the same single-letter law) |
