...
- **(c) 数学的深さ** (旧「真の壁」= 2026-07-18 解消済): Ch.9 operational 容量の prolate DOF-per-second カウント (converse 側)。**leg 29 に CLOSED = メイン定理 `contAwgn_eq_shannonHartley` PROOF-DONE sorryAx-free + @audit:ok** — 旧 wall slug `nyquist-2w-dof` は C1 (leg 23) で `plan:` 再分類後、converse 全段 (achievability leg 22 + converse legs 23-29) が project-internal で壁なく着地 (Mathlib gap ゼロ) = 真の壁ではなかった。標本化定理は 2026-07-14 overturn (proof done)。
...
- **執筆済**: 本書 第1〜14章 (CT2 / CT3 / CT4 / CT5 / CT6 / CT7 / CT8 / CT9 / CT10 / CT12 / CT11 / CT13 / CT14 / CT15)。各章とも査読 2 周 + 公開まで完了。未執筆は 第15〜16章 (CT16 / CT17) の 2 章で、**次は第15章 (ポートフォリオ理論、CT16)**。
