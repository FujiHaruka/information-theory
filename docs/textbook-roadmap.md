...
- **Ch.10 Rate Distortion**: operational achievability 等 (pmf-form + measure-form 凸性 + n-letter converse は closure 済)。
...
| 10 | Rate Distortion | ✅ | `rate_distortion_achievability`, `rate_distortion_converse_single_shot/_specified`, `rateDistortionFunction_convexOn` (measure 形), `rate_distortion_converse_n_letter_singleLetter` |
