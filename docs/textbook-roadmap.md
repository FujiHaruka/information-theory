...
| 10 | Rate Distortion | ✅ | `rate_distortion_achievability`, `rate_distortion_achievability_operational` (無条件 operational, full-support), `rate_distortion_converse_single_shot/_specified`, `rateDistortionFunction_convexOn` (measure 形), `rate_distortion_converse_n_letter_singleLetter` |
