...
| `isEPIGapMonotoneHyp` | `EPIStamDeBruijnConclusion.lean:139` | `(f : ℝ → ℝ) : IsEPIGapMonotoneHyp f` where `IsEPIGapMonotoneHyp f := 0 ≤ (1/2)*fisherInfoOfDensityReal f` | genuine | ✗ — 上と同じ符号 predicate の言い換え |
