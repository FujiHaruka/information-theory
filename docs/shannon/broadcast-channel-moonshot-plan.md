...
L7 経路構築 #1 まで完了 = **8/20 leg**。**L7 で候補経路が 1 本立った** — R1
(`support-vs-dual-additivity` を経路化。12 ステップ、確信度 `unprobed`、全文は
[`bc-open-problem-routes.md`](bc-open-problem-routes.md))。§3.1 の 5 条件のうち (1)(2)(3) 充足で
**(4) probe / (5) novelty gate は L8** ⟹ 次は L8 = R1 の probe + novelty gate)。
