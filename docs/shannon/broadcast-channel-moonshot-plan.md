...
L0 文献 / L1 数値 probe 基盤 / L2 還元層の決着 / L3 軸 A の最弱仮説抽出まで完了 = 4/20 leg。
分岐点だった L2 は「軸 E に重心を寄せる」を選ばず round-robin 継続、次は L4 = 棚卸し #1)。
