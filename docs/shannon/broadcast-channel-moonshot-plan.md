...
L0 = 文献ランドスケープの verbatim 確定 / L1 = 数値 probe 基盤の建設まで完了 = 2/20 leg。
次の L2 が本 relay の分岐点)。
