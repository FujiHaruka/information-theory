...
L0 文献 / L1 数値 probe 基盤 / L2 還元層の決着 / L3 軸 A / L4 棚卸し #1 / L5 軸 G / L6 軸 B まで完了 =
**7/20 leg**。分岐点だった L2 は「軸 E に重心を寄せる」を選ばず round-robin 継続、L4 が経路構築への
切り替えを L7 に固定。**L5 / L6 で優先度 1・2 の軸が 2 本とも否定的に決着し、両者が同じ前提工事を
指した** ⟹ 次は L7 = 経路構築 #1、主語は `support-vs-dual-additivity`)。
