...
- [~] Phase 4 — converse（`contAwgn_le_shannonHartley`、Phase 2 消費）🔄 **[C1 interlacing = CLOSED（leg 23）。C3 = FULLY CLOSED（leg 24 骨格 + leg 25 L5、`ShannonHartleyConverse.lean`、`contAwgn_operational_converse` 無条件 sorryAx-free + 全 6 leaf @audit:ok）。残 = C2 Gauss 回転 / C4 water-filling+極限 / C0 headline / assembly、全 project-internal・壁なし]**
