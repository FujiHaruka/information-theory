...
- **CT 16.3.1** `competitive_optimality` — KT portfolio `b*` に対し任意 `b` で `E[S_b / S_{b*}] ≤ 1`。
...
- **縮退着地**: P1 (competitive) / P2 (concavity) / P3 (reverse KT) の **3 本で着地**し、forward KT
  ...
  16.3.1 = **3/4 が genuine closure**。forward KT は後続 `portfolio-forward-kt-plan.md` へ分離 (slug 整合)。
