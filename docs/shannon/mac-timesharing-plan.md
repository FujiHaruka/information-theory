...
- [ ] CV — converse half (`{MACAchievable} ⊆ closedConvexHull`) 🚧 → [`mac-timesharing-converse-plan.md`](mac-timesharing-converse-plan.md)（Gap C gateway `mac_avgPentagon_mem_convexHull` ✅ proof-done sorryAx-free `302dbe03`; 残 Gap 0/A/B′ + well-formedness）**← 次**
