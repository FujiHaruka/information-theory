...
- [ ] CV — converse half (`{MACAchievable} ⊆ closedConvexHull`) 🚧 → [`mac-timesharing-converse-plan.md`](mac-timesharing-converse-plan.md)（凸包側 done: Gap C gateway `302dbe03` + pentagon well-formedness `b7a7379f`; **Gap 0 code→ambient bridge done `3377eba5`、`mac_converse_from_code` end-to-end sorryAx-free + 独立監査 PASS**; いずれも proof-done sorryAx-free; 残 = measure 側 Gap A/B′ + CV/V assemble）**← 次 Gap A**
