...
$$
である．$\beta^*_n(\varepsilon)$ は正だから対数がとれ，$\log$ は単調だから $\log\beta^*_n(\varepsilon) \le -n\big(D(P\,\|\,Q)-\delta\big)$ であり，両辺を $-n$ で割れば主張を得る．
:::
...
::: proof
1. 補題 11.2.5 より $D(P\,\|\,Q) = \log 2 - H_b\big(P(0)\big) = \log 2 - H_b(0.1)$ である（$H_b$ は 例 1.1.2 の二値エントロピー関数）．$H_b(0.1) = 0.32508\ldots$，$\log 2 = 0.69314\ldots$ だから，値は $0.36806\ldots$ である．
