...
|---|---|---|
| 東大 2026 第N問 | `todai-2026-q<N>` | `Common2026/T_Q<N>` |
| 東大 2024 第N問 | `todai-2024-q<N>` | `Common2026/T2024_Q<N>` |
| 共通テスト 1A 第N問 | `kyotsu-1a-q<N>` | `Common2026/A_Q<N>` |
| 共通テスト 2B 第N問 | `kyotsu-2b-q<N>` | `Common2026/B_Q<N>` |

生成するファイル:

- `docs/proof-log-<slug>.md` — 質的ログ（人間が書く本文）
...
ユーザーの言う問題から上の表で対応する `Common2026/<prefix>` を決める。例: 東大 2026 第3問なら `Common2026/T_Q3`。
...
{
  "problem": "<日本語の問題名>",
  "proof_log": "docs/proof-log-<slug>.md",
  "sessions": [
    {
      "id": "<完全な UUID>",
...
`references/template.md` を読んで、その骨組みに沿って `docs/proof-log-<slug>.md` を書く。
...
- `git log -p Common2026/<prefix>*` で実際にコミットされた最終形を確認できる
