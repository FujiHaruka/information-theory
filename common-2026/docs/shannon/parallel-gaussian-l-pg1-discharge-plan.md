...
- [x] Phase 0 — 在庫差分: `IsParallelGaussianPerCoordRegularity` 3 field の Mathlib + Common2026 在庫確認 ✅ (2026-05-25, skeleton 着地 + 3 項目 verify)
...
- `h_multivar_decomp` (multivariate channel↔RV MI decomposition) の Mathlib / Common2026
