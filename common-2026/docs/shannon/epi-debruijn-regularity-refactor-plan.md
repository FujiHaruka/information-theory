...
`Common2026/Shannon/EPIStamDischarge.lean:163-175` の caveat
...
**Done 条件**:
- `lake env lean Common2026/Shannon/EPIStamDischarge.lean` が silent (skeleton 段階)
- `rg "@audit:caveat\(epi-debruijn-regularity-integrable-deriv-decoupled\)" Common2026/`
...
```bash
rg -n "isDeBruijnRegularityHyp_of_gaussian|IsDeBruijnRegularityHyp\.of" Common2026/
```
...
**Done 条件**: `rg "epi-debruijn-regularity-integrable-deriv-decoupled" Common2026/ docs/`
が 0 hit。
...
- [ ] `lake env lean Common2026/Shannon/EPIStamDischarge.lean` silent
- [ ] `lake env lean Common2026/Shannon/EPIL3Integration.lean` silent
...
- [ ] `lake env lean Common2026/Shannon/FisherDeBruijnGaussianWitness.lean` silent
...
- `Common2026/Shannon/EPIStamDischarge.lean:176-196` — refactor 対象の現行 structure
- `Common2026/Shannon/EPIStamDischarge.lean:163-175` — caveat docstring (R-4 で削除)
- `Common2026/Shannon/FisherInfoV2DeBruijn.lean:236-249` — `IsRegularDeBruijnHypV2` (V2 sub-predicate)
- `Common2026/Shannon/FisherInfoV2DeBruijn.lean:262-272` — `deBruijn_identity_v2` (V2 sub-predicate consumer)
- `Common2026/Shannon/FisherDeBruijnGaussianWitness.lean:158-166` — `isRegularDeBruijnHypV2_gaussian_heatFlow` (V2 Gaussian witness)
- `Common2026/Shannon/EPIL3Integration.lean:580-593` — `IsHeatFlowFamilyHyp` (案 1 の prior art、同型 paradigm)
- `Common2026/Shannon/EPIL3Integration.lean:520-561` — 親 plan の "Upstream defects" コメント、本 caveat 含む現状記述
