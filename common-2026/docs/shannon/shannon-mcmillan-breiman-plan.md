...
- 上記 4 項目が `lake env lean Common2026/Shannon/Stationary.lean` で silent
- `Common2026.lean` に `import` 行追記
...
2. **Phase A skeleton** — `Common2026/Shannon/Stationary.lean` を sorry-driven で書き始め、
