...
- [~] Phase 3 — a.c. EPI core (case 1) 🚧 **両ルート walled (2026-06-05 確定)**: ratio-limit = entropic CLT 壁 (NO-GO、`epi-case1-ratio-limit-plan`)、difference G3 = false-as-framed D3/D6 もつれ。**honest park 継続** → 既存 plan 群
