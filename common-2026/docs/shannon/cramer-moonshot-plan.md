...
- [x] Phase B — Cramér upper bound (per-n Chernoff + log form, i.i.d. strengthening) ✅ (Tier 1, 2026-05-19)
- [ ] Phase C — Cramér lower bound (tilted change of measure + tilted-下 LLN) 📋
- [ ] Phase D — 主定理 wrapper (`Tendsto` 形 sandwich + `Common2026.lean` 編入) 🔄 (Phase D-4 編入のみ Tier 0 で前倒し済、`Tendsto` sandwich は Tier 2 へ defer)
