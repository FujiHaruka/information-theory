...
> 対象 residual: `InformationTheory/Shannon/ParallelGaussian/PerCoord.lean:717` の
...
`InformationTheory/Shannon/ParallelGaussian/PerCoord.lean:717-720`（verbatim）:
...
`InformationTheory/Shannon/ParallelGaussian/PerCoord.lean:717` の sorry を埋める形（新規 file 不要、
