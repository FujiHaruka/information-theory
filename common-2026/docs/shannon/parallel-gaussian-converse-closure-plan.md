...
`Common2026/Shannon/ParallelGaussianPerCoordRegularity.lean` の constructor
...
Common2026 が必要部品を全て genuine 保有している:
...
新規 `Common2026/Shannon/ParallelGaussianConverse.lean` を起こし、Phase 1-3 の補題群を置く。
...
/ DifferentialEntropy / AwgnCapacityConverseMaxent / Constructions.Pi)。完了時 `Common2026.lean` に import 1 行追加。
