...
> `shannon_mcmillan_breiman` は `InformationTheory/Shannon/SMBAlgoetCover.lean:2840` で完成
...
> (`rg aep_strong_of_smb InformationTheory/` で 0 件)。主定理は本 plan が想定した
...
- E-8 実装: `InformationTheory/Shannon/Stationary.lean` + `EntropyRate.lean`
