...
- **`Common2026` 既存利用**: `Common2026/Shannon/Bridge.lean:43` `entropy μ Xs := ∑ x : X, Real.negMulLog ((μ.map Xs).real {x})` (Fintype 限定)
...
- **`Common2026/Shannon/Pi.lean` 既存定理**:
...
- [x] Phase A skeleton (`Common2026/Shannon/AEP.lean` の sorry-driven 出だし) が書ける状態
