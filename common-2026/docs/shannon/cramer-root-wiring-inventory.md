...
|---|---|---|---|---|
| **A** | `InformationTheory.Shannon.Cramer.Discharge.cramer_lower_phaseC_partial_discharge` | `InformationTheory/Draft/Shannon/CramerLC2PhaseC.lean:147` | `sorry`(:165) | infinitePi 版・headline と同 generality |
| **B** | `InformationTheory.Shannon.Cramer.cramer_lower` | `InformationTheory/Draft/Shannon/Cramer.lean:469` | `sorry`(:483) | 一般 iid `X : ℕ → Ω → ℝ` on bounded `μ`・headline より一般 |
...
|---|---|---|---|---|
| **partial-sum event 移送** | `infinitePi_partialSum_event_eq_pi` | `InformationTheory/Draft/Shannon/InfinitePiTiltedChangeOfMeasure.lean:141` | ✅ 既存(hoist 対象でもある) | `infinitePi {ω | P(∑ Y(ω i))} = Measure.pi (Fin n) {x | P(∑ Y(x i))}` |
...
- `InformationTheory/Draft/Shannon/CramerLC2PhaseC.lean:303` `isMeasureInfinitePiTiltedEq_iff`
- `InformationTheory/Draft/Shannon/InfinitePiTiltedChangeOfMeasure.lean:291` `isMeasureInfinitePiTiltedEq_of_tiltedWindowLarge`
...
- `InformationTheory/Draft/Shannon/CramerLC2PhaseC.lean:167` `cramer_lower_legendre_phaseC_partial_discharge`
- `InformationTheory/Draft/Shannon/InfinitePiTiltedChangeOfMeasure.lean:357` `cramer_lower_phaseC_residual_discharge`
