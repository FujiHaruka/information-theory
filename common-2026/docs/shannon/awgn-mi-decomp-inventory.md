...
> 対象: `IsContChannelMIDecompHyp p W` (`InformationTheory/Shannon/AWGNMIDecompBody.lean:144`) の body 化。
...
`InformationTheory/Shannon/AWGNMIDecompBody.lean:144-149` verbatim:
...
### G. differential-entropy 側 (project 自作、`InformationTheory/Shannon/DifferentialEntropy.lean`)
...
`InformationTheory/Shannon/ContChannelMIDecomp.lean` の出だし (新規ファイル想定):
