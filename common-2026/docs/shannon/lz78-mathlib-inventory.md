# T4-A LZ78 Asymptotic Optimality — Mathlib + Common2026 在庫 (M0)
...
>
> **狙い**: Lempel-Ziv (LZ78) の漸近最適性 (Cover-Thomas Theorem 13.5.3) を Lean 4 + Mathlib 上で 1 ファイル `Common2026/Shannon/LempelZiv78.lean` で publish するための **在庫確認 + 撤退ライン確定 + skeleton 起草**。
>
...
## 1. 自前実装 (Mathlib + Common2026 在庫ゼロ、本 file で初実装)
...
## 2. 既存 Common2026 在庫 (黒箱 reuse、本 plan で再証明しない)

### 2.1 `Common2026/Shannon/Stationary.lean`
...
### 2.2 `Common2026/Shannon/EntropyRate.lean`
...
### 2.3 `Common2026/Shannon/ShannonMcMillanBreiman.lean`
...
### 2.4 `Common2026/Shannon/BirkhoffErgodic.lean`
...
### 2.5 `Common2026/Shannon/AEPRate.lean`, `AEP.lean`
...
### 2.6 `Common2026/Shannon/ShannonCode.lean`, `Huffman.lean`
