...
- [ ] Phase 3b — S2 対称導関数恒等式 (`∫fX' fY(z-·)=∫fX fY'(z-·)`) + S3 score 表現 (確率重み `p_{X|Z}` 明示積分) + S4 点ごと Cauchy-Schwarz 📋 ← **次の一手**
- [ ] Phase 3c — S4 Tonelli 積分 + 3 項評価 (J_X/J_Y/cross=0) + lintegral↔Bochner 橋 (atom A) 📋
- [ ] Phase 3d — assemble: `stam_step2_density_wall` の sorry を genuine 充足 📋
