...
> **先行**: I-1 (`Common2026/Shannon/TypedRV.lean`) / I-3 (`Common2026/InformationTheory/Asymptotic.lean`)
>
...
```lean
-- 新規定義 (`Common2026/Shannon/BlockwiseChannel.lean`)
...
helper として `Common2026/Probability/KernelPi.lean` に切り出す案も検討したが、本 I-2
...
### C-8. ファイル配置 — **1 ファイル `Common2026/Shannon/BlockwiseChannel.lean`**

- 新規ファイル: `Common2026/Shannon/BlockwiseChannel.lean` (~400-500 行見込み)
- `Common2026.lean` に import 1 行追加 (`ChannelCodingShannonTheoremFullDischarge` 系の後、
...
### 新規ファイル: `Common2026/Shannon/BlockwiseChannel.lean`
...
import Common2026.Shannon.EntropyRate -- limit form template
...
新規ファイル `Common2026/Shannon/BlockwiseChannel.lean` を Write、全 sorry で
...
- [ ] **1.6** `Common2026.lean` に `import Common2026.Shannon.BlockwiseChannel` 追記、
...
- [ ] **2.4** `lake env lean Common2026/Shannon/BlockwiseChannel.lean` silent.

**撤退ライン §H-1 ガード**: 2.1 の measurability proof が 30 行を超えたら、
`Common2026/Probability/KernelPi.lean` に切り出して helper 化。本 I-2 plan の subgoal を
...
- [ ] **5.1** `lake env lean Common2026/Shannon/BlockwiseChannel.lean` で 0 sorry / 0 error.
- [ ] **5.2** 在庫 §D の既存 0-sorry ファイル全 silent 確認:
  ...
  - `Common2026/Shannon/ChannelCodingShannonTheorem.lean`
  - `Common2026/Shannon/ChannelCodingShannonTheoremFull.lean`
  - `Common2026/Shannon/ChannelCodingShannonTheoremFullDischarge.lean`
  - `Common2026/Shannon/ChannelCodingShannonTheoremGeneral.lean`
  - `Common2026/Shannon/ChannelCodingConverse*.lean`
  - `Common2026/Shannon/MIChainRule.lean`
  - `Common2026/Shannon/CondEntropyMemoryless.lean`
  - `Common2026/Shannon/EntropyRate.lean`
...
- [ ] **5.4** `Common2026.lean` の全体 silent (= `lake build Common2026` 1 回).
...
`lake env lean Common2026/Shannon/BlockwiseChannel.lean` が **0 sorry / 0 error / 最小 warning**
で pass、かつ以下が全て満たされる:
...
- [ ] `Common2026.lean` に `import Common2026.Shannon.BlockwiseChannel` 追記済.
...
- **対応**: `Common2026/Probability/KernelPi.lean` を独立 helper ファイルとして新規生成、
...
- Inventory: [`general-dmc-mathlib-inventory.md`](./general-dmc-mathlib-inventory.md)
- 先行 I-1: `Common2026/Shannon/TypedRV.lean`
- 先行 I-3: `Common2026/InformationTheory/Asymptotic.lean`
- 既存 `capacity W`: `Common2026/Shannon/ChannelCodingShannonTheorem.lean:102`
- 既存 i.i.d. MI 等式: `Common2026/Shannon/MIChainRule.lean:392`
- 既存 memoryless MI 上界: `Common2026/Shannon/CondEntropyMemoryless.lean:546`
- limit 形 template: `Common2026/Shannon/EntropyRate.lean:69`
...
2. **2026-05-18 実装 (Session 1)**: Phase 0〜3 + Phase 4-β 完了 / Phase 4-α は 1 sorry 残し。
   ...
   - Phase 5: regression check 9 ファイル + 全 library build (`lake build Common2026`) silent.
