...
### 既存 Common2026 補題 (D-2' / E-10' inventory を再利用)
...
- 不在予測: `IsMarkovChain` augment 系の純粋 Mathlib 補題は存在しない (Common2026 で自作確認済)
