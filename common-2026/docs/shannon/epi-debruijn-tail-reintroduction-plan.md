...
- **対象**: 旧 `IsDeBruijnTailHyp X Z P` (元 `Common2026/Shannon/EPIL3Integration.lean:589`)
- **試作品 signature** (要約):
  ```lean
...
- **retract コメント保存場所**:
  `Common2026/Shannon/EPIL3Integration.lean:595-613` (retraction notice)
...
- [ ] Phase T-V — verify (`lake env lean Common2026/Shannon/EPIL3Integration.lean` silent) 📋
...
- [ ] **T-2.1**: `Common2026/Shannon/EPIL3Integration.lean:613` 以下、retract コメント
...
- [ ] **T-2.3**: docstring に下記を明記:
      - Wave 3 third batch retract 経緯への参照
        (`Common2026/Shannon/EPIL3Integration.lean:595-613` retract notice)
...
- [ ] **T-V.1**: `lake env lean Common2026/Shannon/EPIL3Integration.lean` silent
      (0 sorry / 0 warning)
- [ ] **T-V.2**: 必要なら `lake build Common2026.Shannon.EPIL3Integration` で
      olean 再生成 (dependent file の phantom unknown identifier 防止)
- [ ] **T-V.3**: 関連 file の silent 確認:
      - `Common2026/Shannon/EPIStamDischarge.lean` (de Bruijn integration 出力)
      - `Common2026/Shannon/FisherInfoV2.lean` (`gaussianConvolution` 経由)
...
- `lake env lean Common2026/Shannon/EPIL3Integration.lean` silent (0 sorry / 0
  warning)
