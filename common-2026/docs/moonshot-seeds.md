...
>
> **残 deferred**: D-2'' Phase B (`h_yother_zero` 派生は `IsMemorylessChannel` 強化必要、原理的不可)、E-3''' fully-discharged form (~500-800 行)、E-8'' Phase γ helper 3 件 (limsup T-invariance via Etemadi + ergodic discharge + Doob-Hardy boundedness、~150 行)。
>
