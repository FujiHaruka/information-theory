...
> `Common2026/Shannon/StrongTypicality.lean`) は本章作成時点で
...
> 第2章 (`Common2026/Shannon/Bridge.lean`) と同じ measure-theoretic 定義
...
**Verified**: `integral_logLikelihood_zero` (`Common2026/Shannon/AEP.lean`)
...
**Verified**: `aep_inProbability` (`Common2026/Shannon/AEP.lean`)
...
**Verified (定義)**: `typicalSet` (`Common2026/Shannon/AEP.lean`)
...
**Verified**: `measurableSet_typicalSet` (`Common2026/Shannon/AEP.lean`)
...
**Verified**: `typicalSet_prob_tendsto_one` (`Common2026/Shannon/AEP.lean`)
...
**上界 (Verified)**: `typicalSet_prob_le` (`Common2026/Shannon/AEP.lean`)
...
**下界 (Verified)**: `typicalSet_prob_ge` (`Common2026/Shannon/AEP.lean`)
...
**上界 (Verified)**: `typicalSet_card_le` (`Common2026/Shannon/AEP.lean`)。
...
**下界 (Verified)**: `typicalSet_card_ge` (`Common2026/Shannon/AEP.lean`)。
...
**Verified**: `source_coding_achievability` (`Common2026/Shannon/AEP.lean`)
...
**Verified**: `source_coding_converse` (`Common2026/Shannon/AEP.lean`)
...
**Verified (定義)**: `IsAchievableCode` (`Common2026/Shannon/AEP.lean`)
...
**Verified**: `source_coding_theorem` (`Common2026/Shannon/AEP.lean`)
...
**Verified (定義)**: `stronglyTypicalSet` (`Common2026/Shannon/StrongTypicality.lean`)
...
(`Common2026/Shannon/StrongTypicality.lean`)
