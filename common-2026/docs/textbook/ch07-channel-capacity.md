...
> 本文の各主要結果には「**Verified**: `定理名` (`Common2026/...`)」という形で、
...
> 対応する Lean library は `Common2026/Shannon/` の channel-coding 群。
...
**Verified (定義)**: `mutualInfoOfChannel` (`Common2026/Shannon/ChannelCoding.lean`,
...
`mutualInfoOfChannel_eq_HX_add_HY_sub_HZ` (`Common2026/Shannon/ChannelCoding.lean`)
...
**Verified (定義)**: `capacity` (`Common2026/Shannon/ChannelCodingShannonTheorem.lean`,
名前空間 `InformationTheory.Shannon.ChannelCoding`)
...
`jointlyTypicalSet_indep_prob_le` (`Common2026/Shannon/ChannelCoding.lean`)
...
**Verified**: `shannon_converse_single_shot` (`Common2026/Shannon/Converse.lean`,
...
(`Common2026/Shannon/ChannelCodingConverse.lean`, 名前空間 `InformationTheory.Shannon`)
...
(`Common2026/Shannon/ChannelCodingConverseGeneral.lean`,
名前空間 `InformationTheory.Shannon`)
...
(`Common2026/Shannon/ChannelCodingConverseMemorylessPure.lean`,
...
(`Common2026/Shannon/ChannelCodingFeedbackComplete.lean`,
...
(`Common2026/Shannon/ChannelCodingStrongConverse.lean`,
名前空間 `InformationTheory.Shannon.ChannelCoding`)
...
(`Common2026/Shannon/GeneralDMC.lean`, 名前空間 `InformationTheory.Shannon.GeneralDMC`)
...
(`Common2026/Shannon/GeneralDMC.lean`、本体は
...
`capacityRate_ofMemoryless_eventually_const` (`Common2026/Shannon/GeneralDMC.lean`)。
