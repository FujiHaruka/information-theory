...
> 対応する Lean library は `Common2026/Shannon/`。
...
**Verified (定義)**: `StationaryProcess` (`Common2026/Shannon/Stationary.lean`,
...
(`Common2026/Shannon/Stationary.lean`)
...
**Verified (定義)**: `ErgodicProcess` (`Common2026/Shannon/Stationary.lean`)
...
**Verified (定義)**: `blockEntropy` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified (定義)**: `conditionalEntropyTail` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified (定義)**: `entropyRate` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified**: `blockEntropy_succ_chain_rule` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified**: `conditionalEntropyTail_antitone` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified**: `entropyRate_exists_of_stationary` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified**: `entropyRate_eq_lim_condEntropy` (`Common2026/Shannon/EntropyRate.lean`)
...
**Verified (定義)**: `birkhoffAverageReal` (`Common2026/Shannon/BirkhoffErgodic.lean`)
...
**Verified**: `maximal_ergodic_inequality` (`Common2026/Shannon/BirkhoffErgodic.lean`)
...
**Verified**: `birkhoff_ergodic_ae` (`Common2026/Shannon/BirkhoffErgodic.lean`)
...
**Verified (定義)**: `blockLogAvg` (`Common2026/Shannon/ShannonMcMillanBreiman.lean`)
...
(`Common2026/Shannon/ShannonMcMillanBreiman.lean`)
...
**Verified**: `algoet_cover_liminf_bound` (`Common2026/Shannon/SMBAlgoetCover.lean`)
...
**Verified**: `algoet_cover_limsup_bound` (`Common2026/Shannon/SMBAlgoetCover.lean`)
...
(`Common2026/Shannon/SMBAlgoetCover.lean`)
...
**Verified (定義)**: `pmfLogCond` (`Common2026/Shannon/SMBChainRule.lean`)
...
(`Common2026/Shannon/SMBChainRule.lean`)
...
**Verified**: `birkhoffAverage_pmfLogCond_tendsto` (`Common2026/Shannon/SMBChainRule.lean`)
...
**Verified**: `expected_blockLogAvg_eq` (`Common2026/Shannon/ShannonMcMillanBreiman.lean`)
...
**Verified**: `aep_ae` (`Common2026/Shannon/AEP.lean`)
...
- **SMB の仮説なし最終定理（最終配線）**: 4 仮説の discharge 定理
  ...
  単一 declaration は本原稿作成時点で `Common2026/Shannon/` に**存在しない**
