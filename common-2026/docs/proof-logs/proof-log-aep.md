# Proof log — AEP (Phase A〜C 部分撤退)

> **Parent plan**: [`docs/shannon/aep-moonshot-plan.md`](../shannon/aep-moonshot-plan.md)
> **File**: [`Common2026/Shannon/AEP.lean`](../../Common2026/Shannon/AEP.lean) (327 行)
> **Status**: Phase A ✅ / Phase B ✅ / Phase C 部分 (`measurableSet_typicalSet` ✅ / `typicalSet_prob_tendsto_one` ✅ / `typicalSet_card_le` ❌ — `sorry` 残)
> **Verification**: `lake env lean Common2026/Shannon/AEP.lean` 緑通過 (1 sorry warning) / `lake build` 全体緑通過
...
| `typicalSet_card_le` | C | 250 | ❌ (撤退、`sorry` 残) |
