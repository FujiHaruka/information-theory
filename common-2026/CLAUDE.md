...
4. **検証**: 完了時 `lake env lean Common2026/<path>/<file>.lean` が 0 errors (type-check done)。`sorry` warning は許容、ただし各 `sorry` は `@residual(<class>:<slug>)` 付き (配置 + 語彙 → `docs/audit/audit-tags.md`)。
