...
/-- Step 1 and Step 2 together yield the optimal Cauchy-Schwarz form. The combined deliverable:
...
/-- A sanity check that the two-point CS is tight when `(a, b) ∥ (c, d)`, e.g. equality
